          ...
          <div class="product-index">
            <div class="box">
              <div class="box-header">
                  <?= Html::a('Добавление серии товаров', ['create'], ['class' => 'btn btn-success']) ?>
              </div>
              <div class="box-body">
                    ...
                    'columns'      => [
                      ...
                      [
                        ...
                        'value'     => function ($model) {
                            return Html::a($model->name, \yii\helpers\Url::to(['series/update', 'id' => $model->id]));
                        },
                      ],
                      [
                        'attribute' => 'category_id',
                        'format'    => 'raw',
                        'filter'    => ArrayHelper::map(ar\Category::getCategoriesWithoutChild(false,true),
                          'id', 'name'),
                        'value'     =>
                        /**
