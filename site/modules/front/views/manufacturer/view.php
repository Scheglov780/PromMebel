...
/** @var $categories \app\models\ar\Category[] */
/** @var $manufacturer \app\models\ar\Manufacturer */

// Формируем крошку
$this->params['breadcrumbs'] = ['Производитель '.$manufacturer->name];

?>
<?php /* Начало блока описания бренда */ ?>
<div class="brand-title">Производитель <?= $manufacturer->name ?></div>
...
<?php if (!empty($categories) && count($categories)) { ?>
  <div class="category-block">
    <div class="category-header df jc-fs">
      <div class="main-category-title">Товары производителя <?= $manufacturer->name ?></div>
