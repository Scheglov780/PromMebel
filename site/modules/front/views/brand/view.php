...
// Формируем крошку
$this->params['breadcrumbs'] = ['Торговая марка ' . $brand->name];

?>
<?php /* Начало блока описания бренда */ ?>
<div class="brand-title">Торговая марка <?= $brand->name ?></div>
...
<?php if (!empty($categories) && count($categories)) { ?>
  <div class="category-block">
    <div class="category-header df jc-fs">
      <div class="main-category-title">Товары торговой марки <?= $brand->name ?></div>

      <div class="category-line-menu-select"></div>
    </div>
